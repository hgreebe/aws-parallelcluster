...
def _assert_node_version():
    try:
        ...
        LOGGER.error("FileNotFoundError when checking node version:")
        LOGGER.error("  Error: %s", str(e))
        LOGGER.error("  This usually means 'node' is not found in PATH")
        raise
    except Exception as e:
        LOGGER.error("Unexpected exception when checking node version:")
